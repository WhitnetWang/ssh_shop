	...
	<script>
		...
		function checkUserName(){
			...
			if(username == null || username == ""){
				...
				//打开连接
				xhr.open("post","${pageContext.request.contextPath}/user_checkUsername.action",true);
				//设置请求头
		...
		function validate(){
			...
			*/
			...
			if(repassword != password){
				...
				span3.innerHTML = "<font color='red'>两次密码输入不一致</font>";
				return false;
			}else{
				var span3 = document.getElementById("span3");
				span3.innerHTML = "";
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/user_regist.action"  method="post" onsubmit="return validate()">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									...
									<span id="span1"></span>
									<span><font color="red"><s:fielderror fieldName="username"/></font></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											...
											<span><font color="red"><s:fielderror key="checkcode"/></font></span>
										</span>
									</td>
								</tr>
							<tr>
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="${pageContext.request.contextPath }/user_toLoginPage.action">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
