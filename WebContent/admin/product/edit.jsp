			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid">
							<s:iterator value="categorySeconds" var="categorySecond">
								<option <s:if test="model.categorySecond.csid == #categorySecond.csid">selected</s:if> value="<s:property value="#categorySecond.csid"/>"><s:property value="#categorySecond.csname"/></option>
							</s:iterator>	
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						...
						<select name="is_hot">
							<option <s:if test="model.is_hot == 1">selected</s:if> value="1">是</option>
							<option <s:if test="model.is_hot == 0">selected</s:if> value="0">否</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea name="pdesc" rows="4" cols="30">
